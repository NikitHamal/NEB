...
urlpatterns = [
    ...
    path('admin/backgroundagent/', views.admin_backgroundagent_list, name='admin_backgroundagent_list'),
    path('admin/backgroundagent/new/', views.admin_backgroundagent_new, name='admin_backgroundagent_new'),
    path('admin/backgroundagent/<str:session_id>/', views.admin_backgroundagent_detail, name='admin_backgroundagent_detail'),
    path('admin/backgroundagent/<str:session_id>/action/', views.admin_backgroundagent_action, name='admin_backgroundagent_action'),

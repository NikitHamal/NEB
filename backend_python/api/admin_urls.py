...
urlpatterns = [
    ...
    path('admin/resources/pending/', admin_views.admin_pending_resources, name='admin-pending-resources'),
    path('admin/resources/<str:resource_id>/', admin_views.admin_resource_detail, name='admin-resource-detail'),
    path('admin/resource-requests/', admin_views.admin_resource_requests, name='admin-resource-requests'),
    path('admin/resource-requests/<str:request_id>/', admin_views.admin_resource_request_update, name='admin-resource-request-update'),

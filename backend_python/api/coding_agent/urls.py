...
urlpatterns = [
    ...
    path('ajax/upload-attachment/', views.ajax_upload_attachment, name='ajax_upload_attachment'),
    ...
    path('ajax/sessions/<str:session_id>/workspace-files/', views.ajax_session_workspace_files, name='ajax_session_workspace_files'),
    path('ajax/sessions/<str:session_id>/file-content/', views.ajax_session_file_content, name='ajax_session_file_content'),
    path('ajax/sessions/<str:session_id>/logs/', views.ajax_session_logs, name='ajax_session_logs'),

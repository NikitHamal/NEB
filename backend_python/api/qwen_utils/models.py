    ...
    return [
        {
            "id": "qwen3.7-plus",
            "name": "Qwen3.7-Plus",
            "capabilities": {"vision": True, "document": True, "video": True, "audio": True, "thinking": True, "search": True, "citations": False},
        ...
        },
        {
            "id": "qwen3.7-max",
            "name": "Qwen3.7-Max",
            "capabilities": {"vision": False, "document": True, "video": False, "audio": False, "thinking": True, "search": False, "citations": False},
            "max_context_length": 1000000,
            "is_active": True,
        },
        {
...
def get_default_model(force_refresh=False):
    ...
    try:
        ...
        for m in models:
            if m["is_active"] and m["capabilities"].get("vision") and m["capabilities"].get("document"):
                default = m["id"]
                break
    except Exception:
        pass

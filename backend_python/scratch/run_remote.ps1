...
# Command to run on the server is passed as first argument, default to viewing the file snippet
$cmd = $args[0]
if (-not $cmd) {
    $cmd = "sed -n '45,55p' /home/consicac/nebians_api/web/views_forum.py"
}

Write-Host "Running remote command: $cmd"

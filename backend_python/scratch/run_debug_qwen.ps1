# Run debug_qwen_response.py on remote server
...
& scp -o StrictHostKeyChecking=no -i $keyPath -P 22 "f:\NEB\backend_python\scratch\debug_qwen_response.py" "${username}@${hostIp}:/home/consicac/nebians_api/debug_qwen_response.py"

# Run remote script
$runCmd = "cd /home/consicac/nebians_api && source /home/consicac/virtualenv/nebians_api/3.13/bin/activate && python debug_qwen_response.py && rm -f debug_qwen_response.py"

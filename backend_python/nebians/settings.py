...
# Durable background coding agent.
# Run separately from the web server with:
#   python manage.py run_background_agent_worker
BACKGROUND_AGENT_ROOT = Path(os.environ.get('BACKGROUND_AGENT_ROOT', BASE_DIR / 'background_agent_data'))
BACKGROUND_AGENT_GITHUB_CLIENT_ID = os.environ.get('BACKGROUND_AGENT_GITHUB_CLIENT_ID', GITHUB_CLIENT_ID)
BACKGROUND_AGENT_GITHUB_CLIENT_SECRET = os.environ.get('BACKGROUND_AGENT_GITHUB_CLIENT_SECRET', GITHUB_CLIENT_SECRET)
BACKGROUND_AGENT_GITHUB_SCOPES = os.environ.get('BACKGROUND_AGENT_GITHUB_SCOPES', 'repo workflow read:org user:email')
BACKGROUND_AGENT_GITHUB_API_URL = os.environ.get('BACKGROUND_AGENT_GITHUB_API_URL', 'https://api.github.com')
BACKGROUND_AGENT_MODEL_MAX_TOKENS = int(os.environ.get('BACKGROUND_AGENT_MODEL_MAX_TOKENS', '6000'))
BACKGROUND_AGENT_PROVIDER_ATTEMPTS = int(os.environ.get('BACKGROUND_AGENT_PROVIDER_ATTEMPTS', '3'))
BACKGROUND_AGENT_FORMAT_RETRIES = int(os.environ.get('BACKGROUND_AGENT_FORMAT_RETRIES', '1'))
BACKGROUND_AGENT_COMMAND_TIMEOUT = int(os.environ.get('BACKGROUND_AGENT_COMMAND_TIMEOUT', '300'))
BACKGROUND_AGENT_PATCH_TIMEOUT = int(os.environ.get('BACKGROUND_AGENT_PATCH_TIMEOUT', '900'))
BACKGROUND_AGENT_MAX_COMMAND_TIMEOUT = int(os.environ.get('BACKGROUND_AGENT_MAX_COMMAND_TIMEOUT', '1200'))
BACKGROUND_AGENT_MAX_FILE_READ_BYTES = int(os.environ.get('BACKGROUND_AGENT_MAX_FILE_READ_BYTES', '500000'))
BACKGROUND_AGENT_MAX_SEARCH_BYTES = int(os.environ.get('BACKGROUND_AGENT_MAX_SEARCH_BYTES', '25000000'))
BACKGROUND_AGENT_MAX_WRITE_BYTES = int(os.environ.get('BACKGROUND_AGENT_MAX_WRITE_BYTES', '2000000'))
BACKGROUND_AGENT_MAX_OUTPUT_FILE_BYTES = int(os.environ.get('BACKGROUND_AGENT_MAX_OUTPUT_FILE_BYTES', '250000000'))
BACKGROUND_AGENT_ALLOWED_COMMANDS = os.environ.get('BACKGROUND_AGENT_ALLOWED_COMMANDS', '')
BACKGROUND_AGENT_EXECUTION_BACKEND = os.environ.get('BACKGROUND_AGENT_EXECUTION_BACKEND', 'docker')
BACKGROUND_AGENT_ALLOW_LOCAL_EXECUTION = env_bool('BACKGROUND_AGENT_ALLOW_LOCAL_EXECUTION', False)
BACKGROUND_AGENT_DOCKER_IMAGE = os.environ.get('BACKGROUND_AGENT_DOCKER_IMAGE', 'nebians-background-agent-sandbox:latest')
BACKGROUND_AGENT_DOCKER_NETWORK = os.environ.get('BACKGROUND_AGENT_DOCKER_NETWORK', 'none')
BACKGROUND_AGENT_DOCKER_CPUS = os.environ.get('BACKGROUND_AGENT_DOCKER_CPUS', '2')
BACKGROUND_AGENT_DOCKER_MEMORY = os.environ.get('BACKGROUND_AGENT_DOCKER_MEMORY', '4g')
BACKGROUND_AGENT_DOCKER_PIDS = os.environ.get('BACKGROUND_AGENT_DOCKER_PIDS', '256')

...
* **Neby AI Integration:** Leverage our custom LLM proxy. Students can click **"Quiz Me on This"** while reading a specific PDF. Neby AI will parse the document, generate a 5-question multi-choice quiz, grade the answers in real-time, and explain incorrect choices.

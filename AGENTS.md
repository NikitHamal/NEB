...
- **Admin superuser credentials:** ROTATED Sep 2026 (removed from this file). See password manager / server operator. Never commit credentials here.
...
### Admin Credentials
- **Custom admin panel** (`/admin/`): Login with Django staff superuser account (username `admin`; password ROTATED Sep 2026 - see password manager, never commit here)
